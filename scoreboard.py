...
class Score():
    ...
    def pre_level(self):
        ...
        self.level_rect.bottom = self.screen_rect.bottom - 55

    def prep_ships(self):
        self.ships = Group()
        for ship_nimber in range(self.stats.ship_left):
            ship = Ship(self.ai_game)
            ship.rect.x = 10 + ship_nimber * ship.rect.width
            ship.rect.y = 10
            self.ships.add(ship)
